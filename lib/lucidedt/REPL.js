...
    "dojo/text!./templates/REPL.html",
	...
	"dijit/form/Textarea"
], function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, keys, JSON, globalEval, CoffeeScript, ContentPane) {
			...
			require(["dojo/promise/Promise"], function(Promise) {
				if (value instanceof Promise) {
					...
					value.then(function(result) {
						...
						self.printWithin(response, error);
				...
				response.appendChild(document.createElement("div"))
						.appendChild(value);
			});
		},
