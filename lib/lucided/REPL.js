...
    "dojo/text!./templates/REPL.html",
	...
	"dijit/form/ComboBox"
], function(declare, _LayoutWidget, _TemplatedMixin, _WidgetsInTemplateMixin, template, Memory, keys, on, JSON, Promise, globalEval, CoffeeScript, ContentPane) {
...
        templateString: template,
		...
		eval: function (value, options) {
			...
			if (value != "") {
				this.expressionInput.store.put({ id: value });
		...
		postCreate: function () {
			...
			self.expressionInput.set('store', self.history);
